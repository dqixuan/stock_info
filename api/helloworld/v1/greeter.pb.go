...
const file_helloworld_v1_greeter_proto_rawDesc = "" +
	"\n" +
	"\x1bhelloworld/v1/greeter.proto\x12\rhelloworld.v1\x1a\x1cgoogle/api/annotations.proto\"\x12\n" +
	"\x10StockInfoRequest\"\x10\n" +
	"\x0eStockInfoReply\"\"\n" +
	...
	"\tSaveStock\x12\x1f.helloworld.v1.StockInfoRequest\x1a\x1d.helloworld.v1.StockInfoReply\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/api/stockBT\n" +
	"\x1cdev.kratos.api.helloworld.v1B\x11HelloworldProtoV1P\x01Z\x1fstock_info/api/helloworld/v1;v1b\x06proto3"
...
var file_helloworld_v1_greeter_proto_goTypes = []any{
	(*StockInfoRequest)(nil), // 0: helloworld.v1.StockInfoRequest
	(*StockInfoReply)(nil),   // 1: helloworld.v1.StockInfoReply
...
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.v1.Greeter.SaveStock:input_type -> helloworld.v1.StockInfoRequest
	3, // 2: helloworld.v1.Greeter.SayHello:output_type -> helloworld.v1.HelloReply
	1, // 3: helloworld.v1.Greeter.SaveStock:output_type -> helloworld.v1.StockInfoReply
